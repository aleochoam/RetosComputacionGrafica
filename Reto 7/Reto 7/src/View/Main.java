...
public class Main extends JPanel {
    ...
    public void createScene() {
        AmbientLight al = new AmbientLight(new Colour(0, 0, 1));
        ...
        */
        ...
        /**
         * Kd y Ks empiezan en cero, Ks varía en el ciclo interno y
         * Kd en el ciclo externo, ambos aumentan en 0,2 cada iteracion
         */
        n = 4;
        for(int fila = 0; fila <= 4; fila ++) {
            ...
            for(int col = 0; col <= 4; col++) {
                ...
                sp = new Sphere(new Point(centerX, centerY, -100), 5.5, material);
                Scene.addSphere(sp);
                Kd += delta;
            }
            n += 4;
